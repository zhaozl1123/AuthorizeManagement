...
imagePath = Image.open("/workbench/DEC-logo-whiteBgBlueFont.jpeg")
...
if __name__ == '__main__':
    ...
    tagContainerFormCol02.text_input("标签值", key="value01", placeholder="无符号")
    tagContainerFormCol02.text_input(" ", key="value02", label_visibility="collapsed", placeholder="无符号")
    tagContainerFormCol02.text_input(" ", key="value03", label_visibility="collapsed", placeholder="无符号")
    tagContainerFormCol02.text_input(" ", key="value04", label_visibility="collapsed", placeholder="无符号")
    tagContainerFormCol02.text_input(" ", key="value05", label_visibility="collapsed", placeholder="无符号")
